...
from organizer import NA, assess_confidence, load_schema, organize_file
...
def organize():
    ...
    # the file parsed and produced rows, but the layout likely wasn't really
    # recognized (core fields missing, or a column landed on the wrong data)
    report["low_confidence"], report["low_confidence_reasons"] = assess_confidence(df)
